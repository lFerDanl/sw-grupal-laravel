{{-- resources/views/components/apuntes/explicacion.blade.php --}}
@props(['apuntes'])

<div class="tab-pane fade" id="explicacion" role="tabpanel" aria-labelledby="explicacion-tab">
  @forelse($apuntes as $a)
    <div class="card shadow-sm mb-4">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-start mb-3">
          <h5 class="card-title mb-0">
            <i class="bi bi-book-fill text-info me-2"></i>{{ $a->titulo }}
          </h5>
